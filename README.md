...
- GitHub Actions 在 `:03/:08/:13/:18/:23/:28/:33/:38/:43/:48/:53/:58` 错峰运行，约每 5 分钟尝试刷新一次。
...
- 每个空投日程都会内置 Apple Calendar 提醒，开始前 15 分钟弹出。
...
建议把自动刷新设置为每 5 分钟或每 30 分钟；Apple Calendar 可能不会严格按订阅文件里的刷新提示执行。
